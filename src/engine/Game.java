...
public class Game { 
	...
	public ModelListener getMyListener() {
		return myListener;
	}

	public void setMyListener(ModelListener myListener) {
	...
	public void useLeaderAbility() throws LeaderNotCurrentException, LeaderAbilityAlreadyUsedException {
		...
		//gui line 
		myListener.onCastLeaderAbility();
	}
	...
	public Ability getAbilityByName(ArrayList<Ability> a,String s){
		for(int i=0 ; i<a.size(); i++)
		{
			if(a.get(i).getName().equalsIgnoreCase(s))
				return a.get(i);
		}
		//da ai habal el mafroud matewsalsh l hena aslun
		return new DamagingAbility("balabizo",0,0,0,AreaOfEffect.DIRECTIONAL,0,0);
	}
